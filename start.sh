...
CPU_LIMIT=
MEMORY_LIMIT=
LOG_FILE="/tmp/ams_test_node.log"
TEST_MODE=false 
...
if [ "$TEST_MODE" = true ]; then
  echo "=== TEST MODE: Parameters successfully parsed ==="
  echo "USE_GLOBAL_IP=$USE_GLOBAL_IP"
  echo "USE_PUBLIC_IP_AS_SERVER_NAME=$USE_PUBLIC_IP_AS_SERVER_NAME"
  echo "REPLACE_CANDIDATE_ADDRESS_WITH_SERVER_NAME=$REPLACE_CANDIDATE_ADDRESS_WITH_SERVER_NAME"
  ...
  echo "JVM_MEMORY_OPTIONS=$JVM_MEMORY_OPTIONS"
